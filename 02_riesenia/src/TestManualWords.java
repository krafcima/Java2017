...
public class TestManualWords {
 
	@Test
	public void testPalindrom() {
		assertTrue("Kuna nese nanuk",Words.palindrom("Kuna nese nanuk"));
		assertFalse("Abab",Words.palindrom("Abab"));
		assertTrue("Aba",Words.palindrom("Aba"));
		assertTrue("AbBa",Words.palindrom("AbBa"));
		assertTrue("A",Words.palindrom("A"));
		assertFalse("Chora Marka na Kramaroch",Words.palindrom("Chora Marka na Kramaroch"));
		assertTrue("Signate, signate, mere me tangis et angis",Words.palindrom("Signate, signate, mere me tangis et angis"));
    System.out.println("palindrom ok, 1 bod");
	}

	@Test
	public void testPanagram() {
		assertFalse("abcd",Words.panagram("abcd"));
		assertFalse("abcdefghijklmnoprstuvwxyz",Words.panagram("abcdefghijklmnoprstuvwxyz"));
		assertFalse("abcdefghijklmnoprstuvwxyzqq",Words.panagram("abcdefghijklmnoprstuvwxyzqq"));
		assertFalse("aba",Words.panagram("aba"));
		assertFalse("The quick brown fox jumps over the lazy dog",Words.panagram("The quick brown fox jumps over the lazy dog"));
		assertFalse( "Quick hijinx swiftly revamped gazebo",Words.panagram( "Quick hijinx swiftly revamped gazebo"));
		assertFalse("Portez ce vieux whisky au juge blond qui fume" ,Words.panagram("Portez ce vieux whisky au juge blond qui fume"));
		assertTrue("D.V. Pike flung J.Q. Schwartz my box.",Words.panagram("D.V. Pike flung J.Q. Schwartz my box."));
		assertTrue("Dwarf mobs quiz lynx.jpg, kvetch",Words.panagram("Dwarf mobs quiz lynx.jpg, kvetch"));
		assertTrue("JFK got my VHS, PC and XLR web quiz.",Words.panagram("JFK got my VHS, PC and XLR web quiz."));
    System.out.println("panagram ok, 2 body");
}

	@Test
	public void testAnagram() {
		assertFalse("abcd-addc",Words.anagram("abcd","addc"));
		assertFalse("abd-addc",Words.anagram("abd","addc"));
		assertFalse("aaa-aaaaaa",Words.anagram("aaa","aaaaaa"));
		assertTrue("The Detectives = Detect Thieves",Words.anagram("The Detectives", "Detect Thieves"));
		assertTrue("The Hospital Ambulance = A Cab, I Hustle to Help Man",Words.anagram("The Hospital Ambulance", "A Cab, I Hustle to Help Man"));
		assertTrue("The United States of America = Attaineth its cause, freedom",Words.anagram("The United States of America" , "Attaineth its cause, freedom"));
		assertTrue("Salman Rushdie = Read, Shun Islam",Words.anagram("Salman Rushdie" , "Read, Shun Islam"));
		assertTrue("To be or not to be: that is the question, whether tis nobler in the mind to suffer the slings and arrows of outrageous fortune. = In one of the Bards best-thought-of tragedies, our insistent hero, Hamlet, queries on two fronts about how life turns rotten.",
				Words.anagram("To be or not to be: that is the question, whether tis nobler in the mind to suffer the slings and arrows of outrageous fortune.", "In one of the Bards best-thought-of tragedies, our insistent hero, Hamlet, queries on two fronts about how life turns rotten."));
    System.out.println("anagram ok, 2 body");
}

	@Test
	public void testPalindromHard() {
		String words_17_826 = words_17_826y + words_17_826x+ words_17_826z; 
		assertTrue("17.826 words...",Words.palindrom(words_17_826));
    System.out.println("palindromHard ok - Gratulujem - nehodnotene kvoli problemu so serverom ");
	}

	@Test
	public void testAnagramHard() {
		String words_17_826 = words_17_826y + words_17_826x+ words_17_826z; 
		System.out.println(words_17_826.length());
		assertFalse("words 17.826",Words.anagram(words_17_826, words_17_826+"a"));
		assertFalse("words 17.826",Words.anagram(words_17_826, words_17_826.replace("a", "b")));
    System.out.println("anagramHard ok - Gratulujem - nehodnotene kvoli problemu so serverom ");
	}
  
  
	String words_17_826y = 
		...
		"Pittel, a valor, Itonia, Tamra, Kamal, Edana, Cly, Redd, a tin, Gaza,"+
		"CNS, Ultan, a haik, Nedra, Hyo, FRCS, orgies, a tub, Rabaul, Canea,"+
		"Calva, Koren, Elgon, a trf, Aesir, Tema, Leda, Tica, DJS, Roe, Lanam,"+
		"Haida, Bezwada, a grub, Lawry, Sarge, Lelah, Cimon, a vote, Naor,"+
		"Alcatraz, O'Malley, Ivis, IADB, Roswell, Eboh, Tosca, Sik, Naylor, a"+
		"kore, IPY, Al Pacino, valses, a cesura, ducs, a kale, Bald, Etta,"+
		"Verena, RCS, Etan, an ova, Shira, Bar, CCP, Murat, Somnus, Mahren,"+
		"Rubens, IAS, Berk, a bod, cates, a yam, a ten, a zakat, a jazy, Roca,"+
		"a den, Sum, Edris, a berg, Ona, Melli, Wran, Dobro, Niagara, Hopis,"+
		"LaSorella, Backer, Ragnar, Okla, Anitra, Neddra, hamli, Snapp, Ellyn,"+
		"Iva, Des, Behar, OFris, a puce, Yenan, Averell, Eufaula, LBP, Wiak,"+
		"Bob, a kaiak, a susu, Shani, Bib, Laon, a teacup, Gond, Yahgans, a"+
		"loop, Virgo, Sina, an one, Wina, a jake, Kanaka, a site, Ball, Orkhon,"+
		"Sung, IPA, a col, anni, a tramline, Bello, Cindy, OLLA, Leibniz,"+
		"Erbil, Apulia, Pammi, Rgen, Yard, Lad, Tera, a dan, Ito, Rashi, Ewald,"+
		"Omer, Cagle, byre-men, Say, Gilud, Omar, Omaha, RPO, Likasi, Putnem,"+
		"Lohman, Irus, PYT, a bor, Baber, Ohare, Fallon, Egan, a dinar, Aloke,"+
		"Kyra, Ranie, Norty, Lena, Pip, a grebe, Ino, LCT, Ialysus, a spa,"+
		"Curt, a mall, Ard, Calen, Outhe, Parke, Bubalo, Tamanaha, Manado,"+
		"opai, Gart, Ziv, a bit, a roof, masais, lekanai, Latia, Watt, Utley, a"+
		"glia, Tait, an odd, Logan, Airedale, Bamako, Rianna, Bruyn, a z-axis,"+
		"OPA, kakapos, a gid, Neff, a radar, Ewold, crases, Ibiza, RMA, Tula,"+
		"Essen, Ulane, Guedalla, Baroda, Maren, Naman, Nina, a stir, a mary,"+
		"Tia, Baese, Onega, Duhl, Uball, a tsade, Mahla, Dayle, Eno, a buhr,"+
		"Apl, a bag, Evita, Garbo, Calli, Rema, Tama, a cera, Nast, Rahab, MeV,"+
		"Ola, a cod, Uele, a fartlek, a dig, Irbil, a madame, Nika, Arne, Mada,"+
		"Carey, Gehenna, Idabel, Ganny, Lyman, Y-level, Elora, Pahl, IHS, Taka,"+
		"Naga, Ethe, YWCA, Nes, Billie, Nos, Laetitia, Hedy, E.H. Moore,"+
		"Lasala, Tina Arena, a lug, Ade, Ens, Sumo, Cons, an aider, a wallow,"+
		"Estron, Sang, Isadora, Heda, Cranaus, a tahr, Riba, Dina, Mas, deti,"+
		"Nuri, Marr, a floss, a milady, a rfb, Solley, lares, a mog, Ladew, a"+
		"coll, Ebba, Algeria, LCVP, Minabe, Zobe, Sassari, Dasi, caca, Mrike,"+
		"Rajab, a sacaton, IMF, CSA, an aug, Ina, Sacco, Napa, Nahama, Rechaba,"+
		"Roos, Asar, a dor, EHFA, John, Imitt, EDC, Eraste, Donella, Cmon,"+
		"Rosol, Rafaela, Derina, Ubald, Siwash, Ariew, a gale, pis, Sibel,"+
		"Patsis, Erasme, Edan, Nireus, Sita, Ion, Matsys, Tebet, IHD, Lihue,"+
		"Morie, Doi, R. Ravi, varia, Davon, a moror, Epp, Arcaro, Tabor, Paros,"+
		"Netaji, Gannes, a fit, a load, Aruba, Bebel, Gabel, BAg, Nepal, LBJ,"+
		"SbW, Oralie, Waki, Sadler, egesta, INH, Orton, a jello, Iviza, Nader,"+
		"Flessel, Tamas, Sirach, a tafia, Brunn, EKG, Ogdan, Ogaden, Ralph,"+
		"Bacis, a bane, MEPA, Sulla, Griz, Takao, Blighty, Soble, Grass,"+
		"Averyl, a giron, Aia, buddies, Repeal, a bat, Samala, a thana, Lanni,"+
		"Viva, Hazard, Erfurt, Sinatra, Buatti, Malta, Zama, Sirois, Orson, a"+
		"rennin, a gel, Goda, Neri, a denier, Kari, Orem, Oran, Ugo, Puck,"+
		"Camarata, Nammu, DVS, EMet, a mar, a labrid, a galah, Catie, HRIP,"+
		"Utgard, an arak, Nassir, Roldan, Emarie, Weiler, UAW, a ballet,"+
		"Sirkin, a lupus, a raw, a jouk, Dew, Sulu, Mahanadi, AMT, an aph,"+
	...
	String words_17_826x = 
		...
		"Vanessa, Melosa, Sofko, BSME, Galligan, a meta, Galofalo, Tini,"+
		...
		"hairball, Ahl, a wawa, Ziwot, a misc, a fa-la, Yin, a dop, Meta, Eula,"+
	...
	String words_17_826z = 
		...
		"zee, Dominic, cacei, Gobert, Nevai, Bretagne, Hagi, Leesen, a dust, a"+
